...
void PLL::adjustUFace(CubeS &cube) {
  while (cube.cubies[2][5] != 5 || cube.cubies[0][2] != 2) {
    cube.moves("U");
  }
}

void PLL::solveEdges(CubeS &cube) {
...
void PLL::solveCorners(CubeS &cube) {
...
int PLL::checkCorners(CubeS &cube) {
